    ...
    <div class="container">
        <table class="table table-striped table-bordered">
            ...
            <?php
                ...
                $query = "SELECT * FROM friends WHERE friends.friend_id IN ( SELECT myfriends.friend_id2 FROM myfriends WHERE myfriends.friend_id1 = $userID)";
                ...
                if(mysqli_num_rows($result) > 0) {
                    while($row = mysqli_fetch_assoc($result)) {
                        ...
                        echo '<td width="50px"><form action="friendlist.php" method="POST"><input name="id" value="' . $row['friend_id'] . '" hidden="hidden"></input><button type="submit" name="unfriend" class="btn btn-warning">Unfriend</button></form></td>';
                        echo "</tr>";
                    }
                }
